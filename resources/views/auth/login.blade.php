    ...
    <div class="card-body login-card-body">
      ...
      <form method="POST" action="{{ route('login') }}">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control @error('username') is-invalid @enderror" placeholder="Usuario" id="username" name="username" value="{{ old('username') }}" required autofocus>
